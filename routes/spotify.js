  ...
  await spotifyApi.getMe().then(
    function (data) {
      ...
      let dataUser = {
        ...
        display_name:
          data.body.display_name != null ? data.body.display_name : '',
      ...
      userData.displayName =
        dataUser.display_name != '' ? dataUser.display_name : dataUser.id;
...
router.get('/', async function (req, res, next) {
  if (req.cookies.spotify_access_token === undefined) {
    ...
    if (playback.deviceId !== null) {
      ...
      console.info(
        '= ' + user.displayName + ' ♫ Now Playing:',
        renderData.title + ' · ' + renderData.artist + ' ='
      );
